...
with open(r"C:\Users\YOUR_USER\Documents\miR.txt", "r") as file:
...
# Output file
output_file = r"C:\Users\YOUR_USER\Documents\raw_int_ENCORI.txt"
...
for miRNA in miRNAs:
    ...
    try:
        ...
        response = session.get("https://rnasysu.com/encori/api/miRNATarget/", params=params, verify=True)
